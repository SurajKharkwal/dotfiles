...
print("scheme",args.scheme, scheme)
...
# Terminal Colors
if args.term_base is not None:
    with open(args.term_base, "r") as f:
...
# write to files
with open(args.m3_output, "w") as f:
    json.dump(material_colors, f, indent=2)

with open(args.term_output, "w") as f:
